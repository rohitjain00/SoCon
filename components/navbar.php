    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0" style="font-size: 30px; text-align: center;">
            ...
            <li class="nav-item active" style="font-size: 20px; padding-top: 10px;">
                <a class="nav-link" href="../views/Profile.php"><i style="font-size: 25px;" class="fa fa-user-circle-o" aria-hidden="true"></i>
        ...
        <form class="form-inline my-2 my-lg-0" action="../views/searchResults.php" method="post">
